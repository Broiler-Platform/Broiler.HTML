...
Broiler.HTML contains substantial AI-assisted implementation. This record exists so that a
...
- **Scope:** The HTML/CSS renderer, layout and painting pipeline, image and WPF adapters, command-line renderer, and WPT tooling.
...
- [ ] Build and automated tests completed; minimum expected commands: `dotnet build Source/Broiler.HTML.slnx`, `dotnet test Source/Broiler.HTML.slnx`, and `npm test`.
